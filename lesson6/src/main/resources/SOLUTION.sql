...
SELECT DISTINCT STUDENT.NAME FROM STUDENT INNER JOIN PAYMENT on STUDENT.ID = PAYMENT.STUDENT_ID where PAYMENT.TYPE_ID = (select id from paymenttype where NAME ='WEEKLY');
